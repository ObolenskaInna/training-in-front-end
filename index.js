...
//var msg ="hello JavaScript";
    //console.log (msg);
    // alert (msg); - for alert windows with button 'Ok'

//var resultsDiv = document.getElementById ("results");
    //resultsDiv.innerHTML = "<p> This is from JavaScript </p>";

var resultList = $("#resultList");
resultList.text("This is form jQuery");

var toggleButton = $("#toggleButton");
toggleButton.on("click", function (){
    resultList.toggle(500);

    // Changing the name on button
...
var gitHubSearch = "http://api.github.com";
$.get(gitHubSearch, function (r) {
    //console.log(r.items.length);
    display.results(r.items);
});
...
/*
msg is string
resultsDiv is object
none is undefined
aNumber is number
trueFalse is boolean
*/
...
/* function showMsg(msg, more) {
    //console.log (more);
    if (more)  {
        console.log("showMsg if " + msg + more);
    } else {
        console.log("showMsg else " + msg);
    }
}
